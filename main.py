...
def main():
    ...
    features_perceptron = ["cholesterol", "resting bp s"]
    target_perceptron = ["target"]
    p_features, p_labels = load_features(data_path, features=features_perceptron, target=target_perceptron, remove=True)
